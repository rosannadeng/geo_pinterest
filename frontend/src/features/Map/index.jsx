...
const MapPage = () => {
    ...
    useEffect(() => {
        if (!isLoaded || !inputRef.current || artworks.length === 0) return;
        ...
        const handlePlacesChanged = () => {
            ...
            // Define a search radius of 100km (in degrees)
            const paddingKm = 100;
            const degreePadding = paddingKm / 111;
